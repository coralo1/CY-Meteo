...
set title "température min, max, moy par station" 
...
plot 'filtre.temp' using 1:3:4 with filledcurve fc rgb Shadecolor title "min max", '' using 1:2 smooth mcspline lw 2   title "temp moy"
